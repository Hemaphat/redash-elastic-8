...
RUN if [ "x$skip_frontend_build" = "x" ] ; then NODE_OPTIONS='--max-old-space-size=4096' yarn build; else mkdir -p /frontend/client/dist && touch /frontend/client/dist/multi_org.html && touch /frontend/client/dist/index.html; fi
